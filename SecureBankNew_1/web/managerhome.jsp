  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
          <center>
          <div class="">
           <img src="images/image6.jpg" width="900" height="300"  style="margin-left: -250px;border-radius:20px "/>
          </div></center>

          <div class="article" style="margin-right:35%  ">
<!--          <h2>Customer Transaction Status</h2>
          <form action="txnstatus.jsp">
          <p>Enter the Account number:<input type="text" name="accno" /><input type="submit" /></p>
          </form>-->
        </div>
