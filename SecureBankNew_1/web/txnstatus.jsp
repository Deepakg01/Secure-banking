  ...
  <div class="content">
    <div class="content_resize">
        <div class="mainbar"><div class="article">
              <img src="images/bitcoin1.jpg" width="900" height="300"  style="margin-left: -250px;"/>
        </div>
      ...
      <div style="width: 98%;">
        ...
        <%
            String x= request.getParameter("accno");
        String saccno=null;
        String raccno=null;
        ...
        ResultSet rs=st.executeQuery("select * from transactionhistory where sendername="+x+"");
